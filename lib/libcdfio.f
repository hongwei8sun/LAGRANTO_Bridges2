...
C     Check if a new time step is starting
      ...
      if (iflag.eq.0) then		! new time step
        ...
        call ncvpt1(cdfid,idtime,ntime,real(time),ierr)
...
C------------------------------------------------------------------------
      ...
      if (vtyp.eq.5) then
        do i=1,ntimes
          ...
          call ncvpt1(cdfid,idtime,i,real(times(i)),ierr)
          if (ierr.ne.0) return
        enddo
      elseif (vtyp.eq.4) then ! integer version  
        do i=1,ntimes
      ...
      elseif (vtyp.eq.6) then ! double precision version
        do i=1,ntimes
          ...
          call ncvgt1(cdfid,idtime,i,real(times(i)),ierr) 
          if (ierr.ne.0) return
        enddo        
      else
        return
...
c     not abort execution
      ...
      if (vtyp.eq.5) then
        do i=1,ntimes
          ...
          call ncvgt1(cdfid,idtime,i,real(times(i)),ierr) ! get times
          if (ierr.ne.0) goto 900
        enddo   
      elseif (vtyp.eq.4) then ! integer version  
        ...
        do i=1,ntimes
          ...
          call ncvgt1(cdfid,idtime,i,real(inttimes(i)),ierr) ! get times
          if (ierr.ne.0) goto 900
        enddo
      ...
      elseif (vtyp.eq.6) then ! double precision version
        ...
        do i=1,ntimes
          ...
          call ncvgt1(cdfid,idtime,i,real(doubletimes(i)),ierr) ! get times
          if (ierr.ne.0) goto 900
        enddo
