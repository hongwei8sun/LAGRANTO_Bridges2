...
!      call ncvpt1(cdfid, startyid, 1, stdate(1), ierr) !!! shw
...
!      call ncvpt1(cdfid, startsid, 1, stdate(5), ierr)
      call ncvpt1(cdfid, startyid, 1, real(stdate(1)), ierr)
      call ncvpt1(cdfid, startmid, 1, real(stdate(2)), ierr)
      call ncvpt1(cdfid, startdid, 1, real(stdate(3)), ierr)
      call ncvpt1(cdfid, starthid, 1, real(stdate(4)), ierr)
      call ncvpt1(cdfid, startsid, 1, real(stdate(5)), ierr)

C     Store datatype and version
!      call ncvpt1(cdfid, dattypid, 1, dattyp, ierr)
!      call ncvpt1(cdfid, datverid, 1, datver, ierr)
      call ncvpt1(cdfid, dattypid, 1, real(dattyp), ierr)
      call ncvpt1(cdfid, datverid, 1, real(datver), ierr)

C     Store version of the constants file format
      !call ncvpt1(cdfid, cstverid, 1, cstver, ierr)
      call ncvpt1(cdfid, cstverid, 1, real(cstver), ierr)
...
* store nx,ny,nz
      !call ncapt(cdfid,NCGLOBAL,'nx',NCLONG,1,nx,iret) !!! shw
      !call ncapt(cdfid,NCGLOBAL,'ny',NCLONG,1,ny,iret)
      !call ncapt(cdfid,NCGLOBAL,'nz',NCLONG,1,nz,iret)
      call ncapt(cdfid,NCGLOBAL,'nx',NCLONG,1,real(nx),iret)
      call ncapt(cdfid,NCGLOBAL,'ny',NCLONG,1,real(ny),iret)
      call ncapt(cdfid,NCGLOBAL,'nz',NCLONG,1,real(nz),iret)
...
!      call ncapt(cdfid,NCGLOBAL,'cstver',NCLONG,1,cstver,iret)
      call ncapt(cdfid,NCGLOBAL,'dattyp',NCLONG,1,real(dattyp),iret)
      call ncapt(cdfid,NCGLOBAL,'datver',NCLONG,1,real(datver),iret)
      call ncapt(cdfid,NCGLOBAL,'cstver',NCLONG,1,real(cstver),iret)
...
* store starty, etc
      corner(1) = 1
      edges(1) = 1
      call ncvpt(cdfid, startyid, corner(1), edges(1), idate(1), iret)
      call ncvpt(cdfid, startmid, corner(1), edges(1), idate(2), iret)
      call ncvpt(cdfid, startdid, corner(1), edges(1), idate(3), iret)
      call ncvpt(cdfid, starthid, corner(1), edges(1), idate(4), iret)
